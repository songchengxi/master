            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center">
                        ...
                        <h4 class="blue" id="id-company-text">www.chenxi.com</h4>
                    </div>
                    ...
                    <div class="position-relative">
									...
									<i class="ace-icon fa fa-lock"></i>
                                        ...
                                        <label class="block clearfix">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon" style="padding: 0;"><img
                        ...
                        <div class="center"><h4 class="blue" id="id-company-copy">&copy; master版权所有 </h4></div>
...
//        }
    ...
    function darkStyle() {
        ...
        $('#id-company-copy').attr('class', 'blue');
        e.preventDefault();
    }
    ...
    function blurStyle() {
        ...
        $('#id-company-copy').attr('class', 'light-blue');
        e.preventDefault();
    }
