...
<t:datagrid name="roleUserList" title="common.operation"
            actionUrl="companyRoleController.do?roleUserDatagrid&roleId=${roleId}" fit="true" fitColumns="true" idField="id" queryMode="group">
	...
	<t:dgDelOpt title="common.delete" url="companyRoleController.do?delUserRole&userid={id}&roleid=${roleId }" urlclass="ace_button"  urlfont="fa-trash-o"/>
	...
	<%--<t:dgToolBar title="common.add.exist.user" icon="icon-add" url="companyRoleController.do?goAddUserToRole&roleId=${roleId}" funname="add" width="500"></t:dgToolBar>--%>
</t:datagrid>