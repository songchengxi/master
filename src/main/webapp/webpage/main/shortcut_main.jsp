    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td align="left" style="vertical-align: text-bottom">
                ...
                <div style="position: absolute; top: 75px; left: 33px;">Master<span
                        style="letter-spacing: -1px;"> <t:mutiLang langKey="system.version.number"/></span></div>
            </td>
                        ...
                        <td style="" colspan="2">
                            <div style="background: url(plug-in/login/images/top_bg.jpg) no-repeat right center; float: right;">
                                <div style="float: left; line-height: 25px; margin-left: 70px;">
                                    <div style="float: left; line-height: 25px; margin-left: 70px;">
                                        <div id="noticeTitle"
                                             style="display:none;float:left;text-align:center;color: rgb(255, 255, 255);width: 40px; background: rgb(90, 166, 40);">
                                            公告
                                        </div>
                                        <div id="notice"
                                        ...
                                        <span style="color: #386780"><img
                                                src="${webRoot}/plug-in/login/images/user.png"></span>
                                    ...
                                    <div style="float: left; margin-left: 18px;">
                                        <div style="right: 0px; bottom: 0px;">
                                            ...
                                            <a href="javascript:void(0);" class="easyui-menubutton"
                                               menu="#layout_north_zxMenu" iconCls="icon-exit" style="color: #FFFFFF">
                                                <t:mutiLang langKey="common.logout"/>
                                            </a>
                                        </div>
                                        <div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
                                            <div onclick="openwindow('<t:mutiLang
                                                    langKey="common.profile"/>','userController.do?userinfo')">
                                                <t:mutiLang langKey="common.profile"/>
                                            </div>
                                            <div class="menu-sep"></div>
                                            <div onclick="add('<t:mutiLang
                                                    langKey="common.change.password"/>','userController.do?changepassword','',550,200)">
                                                <t:mutiLang langKey="common.change.password"/>
                                            </div>
                                            <div class="menu-sep"></div>
                                            <div onclick="openwindow('<t:mutiLang
                                                    langKey="common.ssms.getSysInfos"/>','tSSmsController.do?getSysInfos')">
                                        ...
                                        <div id="layout_north_zxMenu" style="width: 100px; display: none;">
                                            <div onclick="exit('loginController.do?logout','<t:mutiLang
                                                    langKey="common.exit.confirm"/>',1);">
...
<!-- 左侧-->
<div region="west" split="true" href="loginController.do?shortcut_top" title="<t:mutiLang langKey="common.navegation"/>"
...
<div id="mainPanle" region="center" style="overflow: hidden;">
    ...
    <style type="text/css">
        ...
        .proccess b {
            ...
            background: url(plug-in/layer/skin/default/loading-2.gif) no-repeat 0 center;
            padding-left: 55px;
    ...
    <div id="maintabs" class="easyui-tabs" fit="true" border="false">
        ...
        <c:if test="${map=='1'}">
            <div class="easyui-tab" title="<t:mutiLang langKey="common.map"/>" style="padding: 1px; overflow: hidden;">
                <iframe onreadystatechange="hiddenloading();" onload="hiddenloading();" name="myMap" id="myMap"
                        scrolling="no" frameborder="0" src="mapController.do?map"
...
<div region="south" border="false" style="height: 25px; overflow: hidden;">
    <div align="center" style="color: #1fa3e5; padding-top: 2px">&copy;
        ...
        <span class="tip">
            <a href="#" title="Master  <t:mutiLang langKey="system.version.number"/>">Master<t:mutiLang
                    langKey="system.version.number"/></a>
