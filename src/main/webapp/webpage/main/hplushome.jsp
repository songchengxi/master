...
<%--<div class="row  border-bottom white-bg dashboard-header">--%>
    ...
    <%--<div class="col-sm-5">--%>
        <%--<h2>--%>
            <%--Jeecg 微云快速开发平台--%>
        <%--</h2>--%>
        <%--<p>JEECG是一款基于代码生成器的J2EE快速开发平台，开源界“小普元”超越传统商业企业级开发平台。引领新的开发模式(Online Coding模式(自定义表单)->代码生成器模式->手工MERGE智能开发)，--%>
                    ...
                    <%--<div class="panel-body">--%>
                        <%--<div class="panel-group" id="version">--%>
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v50">v3.7.1</a><code--%>
                                            <%--class="pull-right">2017.09.20</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                                <%--<div id="v50" class="panel-collapse collapse in">--%>
                                    <%--<div class="panel-body">--%>
                                        <%--<div class="alert alert-warning">此版本为跨时代精良重构版，简化平台功能，优化系统性能，制作完善文档，公司项目平台最佳选择！--%>
                                        <%--</div>--%>
                                        <%--<ol>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v45">v3.7</a><code--%>
                                            <%--class="pull-right">2017.04.20</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v44">v3.6.6</a><code--%>
                                            <%--class="pull-right">2017.02.08</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v41">v3.6.5</a><code--%>
                                            <%--class="pull-right">2016.07.18</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v42">v3.6.4</a><code--%>
                                            <%--class="pull-right">2016.07.01</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v43">v3.6.3</a><code--%>
                                            <%--class="pull-right">2016.04.09</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v31">v3.6.2</a><code--%>
                                            <%--class="pull-right">2016.03.15</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v30">v3.6.0</a><code--%>
                                            <%--class="pull-right">2015.12.04</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v32">v3.5.0</a><code--%>
                                            <%--class="pull-right">2015.03.10</code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
                            ...
                            <%--<div class="panel panel-default">--%>
                                <%--<div class="panel-heading">--%>
                                    <%--<h5 class="panel-title">--%>
                                        <%--<a data-toggle="collapse" data-parent="#version" href="#v33">更多版本...</a><code--%>
                                            <%--class="pull-right"></code>--%>
                                    <%--</h5>--%>
                                <%--</div>--%>
