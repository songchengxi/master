...
<head>
    ...
    <script type="text/javascript">
        $(function() {
            $('#cc').combotree({
                url : 'orgController.do?selOrgTree&selfId=${depart.id}',
                width: 155,
...
<t:formvalid formid="formobj" layout="div" dialog="true" action="orgController.do?save" btnsub="submit">
    ...
    <fieldset class="step">
        ...
        <div align="center">
            ...
            <a href="#" class="easyui-linkbutton" id="btn_reset">重置</a>
        </div>
    </fieldset>
</t:formvalid>
</body>
